...
class TestHelpdeskFetchmail(TestHelpdeskTicketBase):
    ...
    def _create_stage_template(self):
        """Return a minimal mail.template attached to the 'New' stage."""
    ...
    def test_welcome_email_not_sent_for_autogenerated_email(self):
        """_track_template skips the stage template when the incoming email was
        auto-generated.  mail_autogenerated_header sets the
        'mail_autogenerated_header' context key before ticket creation;
        _track_template must respect it."""
        self._create_stage_template()
        ticket = self.env["helpdesk.ticket"].create(
            {
                "name": "Out-of-office auto-reply",
                "description": "I am currently away.",
                "team_id": self.team_a.id,
                "stage_id": self.new_stage.id,
                "partner_email": "oof@example.com",
            }
        )
        # Simulate the context injected by mail_autogenerated_header
        ...
        self.assertNotIn(
            "stage_id",
            result,
            "Welcome email must not be sent in response to an auto-generated email.",
        )
